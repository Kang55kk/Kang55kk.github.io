...
import ShowDetailInfo from '@/components/showDetailInfo/showDetailInfo.vue'
Vue.component('ShowDetailInfo',ShowDetailInfo)
...
import LInputSelect from '@/components/learun-ui-wx/inputSelect.vue'
...
import getPhotoInfo from '@/components/getPhotoInfo/getPhotoInfo.vue'
import single from '@/components/ourComponents/single.vue' 
...
Vue.component('l-input-select', LInputSelect)
...
Vue.component('l-custom-form', LCustomForm)
Vue.component('getPhotoInfo', getPhotoInfo)
